...
Notification = tk.Label(window, text="All things good", bg="Yellow", fg="white", width=15, height=3)

lbl = tk.Label(window, text="Enter id", width=20, height=2, fg="blue", font=('times', 20, 'italic bold '))
...
message = tk.Label(window, text="WELCOME", bg="black", fg="cyan", width=50,
...
lbl2 = tk.Label(window, text="Enter Name", width=20, fg="blue",  height=2, font=('times', 20, 'italic bold '))
lbl2.place(x=200, y=300)

txt2 = tk.Entry(window, width=20, fg="red")
txt2.place(x=550, y=310)

takeImg = tk.Button(window, text="Take Images",command=take_img,fg="cyan", bg="black"  ,width=20  ,height=3, activebackground = "white" ,font=('times', 20, 'italic bold '))
takeImg.place(x=300, y=500)

trainImg = tk.Button(window, text="Train Images",fg="cyan",command=trainimg ,bg="black"  ,width=20  ,height=3, activebackground = "white",font=('times', 20, 'italic bold '))
